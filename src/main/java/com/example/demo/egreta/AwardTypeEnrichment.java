...
public enum AwardTypeEnrichment {
    AVR_AWARD("/dk/atira/pure/award/awardtypes/award/avr_award/award", "Ajuts específics del Vicerectorat", "Ayudas específicas del Vicerrectorado", "Specific grants from vice-chancellor’s office", "Ajudes competitives estatals"),
    ...
    FELLOWSHIP("/dk/atira/pure/award/awardtypes/award/fellowship/award", "Beques", "Becas", "Fellowship", "Ajudes competitives estatals"),
    FIN_AWARD("/dk/atira/pure/award/awardtypes/award/fin_award/award", "Finançament Específic", "Financiación Especifica", "Specific Funding", "Ajudes competitives estatals"),
    INFRASTRUCTURE("/dk/atira/pure/award/awardtypes/award/infraestructure/award", "Infraestructura", "Infrastructure", "Infraestructura", "Ajudes competitives estatals"),
    ...
    MOBILITY_AWARDS("/dk/atira/pure/award/awardtypes/award/mobility_awards/award", "Mobilitat", "Mobiilidad", "Mobility", "Ajudes competitives estatals"),
    OTHER_GRANTS("/dk/atira/pure/award/awardtypes/award/other_grants/award", "Accions complementàries i altres ajuts", "Acciones complementarias y otras ayudas", "Other grants", "Ajudes competitives estatals"),
    ...
    RESEARCH_PROJECTS("/dk/atira/pure/award/awardtypes/award/research_projects_and_other_grants/award", "Projectes i Ajuts a la Recerca", "Proyectos y Ayudas de Investigación", "Research Projects and Other Grants", "Ajudes competitives estatals"),
    RTC_AWARD("/dk/atira/pure/award/awardtypes/award/research_projects_and_other_grants/rtc_award", "RETOS COLABORACIÓN (RTC)", "RETOS COLABORACIÓN (RTC)", "RTC AWARD", "Ajudes competitives estatals"),
    STAFF_TO_INCORPORATE("/dk/atira/pure/award/awardtypes/award/staff_to_incorporate/award", "Incorporació de Personal", "Incorporación de Personal", "Staff to incorporate", "Ajudes competitives estatals"),
    ...
    UAB_RESEARCH_GROUP("/dk/atira/pure/award/awardtypes/award/uab_research_group/award_renovation", "Grups i Xarxes de Recerca", "Grupos y Redes de Investigación", "Research Group and Networks", "Ajudes competitives estatals"),
